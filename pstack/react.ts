...
export type EndpointInput<TEndpoint> =
	TEndpoint extends Endpoint<EndpointKind, infer Input, any> ? Input : never

export type EndpointOutput<TEndpoint> =
	TEndpoint extends Endpoint<EndpointKind, any, infer Output> ? Output : never
...
export type FormSource<TInput> = Endpoint<EndpointKind, TInput, unknown> | Parser<TInput>
			...
			return {
				...
				value:
					...
					Array.isArray(currentValue)
						? currentValue
						: "",
				checked: typeof currentValue === "boolean" ? currentValue : undefined,
				onChange: (event) => {
