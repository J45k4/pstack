...
export class Database {
  ...
  constructor(
    ...
    const input = hasSchema ? (inputOrOptions as SQLInput | undefined) : inputOrSchema as SQLInput | undefined;
  ...
  columnSql(name: string, definition: ColumnDefinition) {
    ...
    const primaryKeyAutoIncrement =
      definition.primaryKey && definition.autoIncrement;
