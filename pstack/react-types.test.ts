...
const getProject = null as unknown as Endpoint<"query", { id: ProjectId }, Project>

const createProject = null as unknown as Endpoint<"mutation", CreateProjectInput, Project>
