  ...
  return (
    <div className="app">
      ...
      <section className="todo-panel">
        ...
        {form.error("title") && (
          <p className="field-error">{form.error("title")}</p>
        )}

        {todos.loading && <p className="todo-status">Loading todos...</p>}
        {Boolean(todos.error) && (
          <p className="field-error">Could not load todos.</p>
        )}
        {Boolean(createTodo.error) && (
          <p className="field-error">Could not create todo.</p>
        )}
